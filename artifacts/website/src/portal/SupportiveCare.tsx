...
import { isSupportiveRole } from "./lib/store";
 ...
 * health, first responders and A&E follow-up. Their own workspace: emergency
 * relay tools plus the shared HIVE booking/consultation membership features.
 * Doctor-only areas (patient files, live medications) are not part of this
 * portal — those live in the GP & HIVE HUB.
 */
export default function SupportiveCare() {
  ...
  const doctor = isPractitioner && !isSupportiveRole(account?.role);
      ...
      <PortalLayout>
        <div className="max-w-md mx-auto text-center py-16">
          ...
          <p className="text-muted-foreground mb-6">
            ...
            occupational health, first response or A&amp;E follow-up — for
            emergency relay tools, HIVE booking and consultations.
          </p>
